...
public class CatDetailActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private ArrayList<Cat> catFavourites = CatDatabase.getCatFavourites();
    Cat cat;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cat_detail_base);

        Intent intent = getIntent();
        String catId = intent.getStringExtra("CatId");

        cat = CatDatabase.getCatById(catId);
        ...
        Response.Listener<String> responseListener = new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                CatDatabase.saveCatImagesToDatabase(cat.getId(), catList);
                Log.e("CatBreedID:", cat.getId());
                System.out.println(CatDatabase.catImages);

                if (!(CatDatabase.catImages.isEmpty())) {
                    String imageUrl = CatDatabase.getImageById(cat.getId()).getImageUrl();
